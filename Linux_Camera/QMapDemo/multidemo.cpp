...
#include "src/QMapControl/GeometryPointArrow.h"
#include "src/QMapControl/GeometryPointCircle.h"
#include "src/QMapControl/GeometryPolygon.h"
#include "src/QMapControl/GeometryWidget.h"
#include "src/QMapControl/LayerGeometry.h"
#include "src/QMapControl/LayerMapAdapter.h"
#include "src/QMapControl/MapAdapterGoogle.h"
#include "src/QMapControl/MapAdapterYahoo.h"
#include "src/QMapControl/MapAdapterWMS.h"
...
void Multidemo::setupMaps()
{
    ...
    m_map_control = new QMapControl(QSizeF(480.0, 270.0));
...
//    std::shared_ptr<MapAdapter> map_adapter(std::make_shared<MapAdapterYahoo>());
    ...
    m_mini_map_control = new QMapControl(QSizeF(50.0, 50.0));
    ...
    m_gps_point = std::make_shared<GeometryPointImage>(PointWorldCoord(0.0, 0.0), "../Dashboard/marker1.png");
...
void Multidemo::addBackButton()
{
    QPushButton *backBtn = new QPushButton("Back", this);
    backBtn->setGeometry(10, 150, 60, 32);
